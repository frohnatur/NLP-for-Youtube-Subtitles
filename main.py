...
grummel_fritz_id = 'PLJzHt0Z4xWmN3Wt8eFdjDWAAzX29RAJCC'
...
if __name__ == '__main__':
    ...
    grummel_fritz_ids = get_video_ids(grummel_fritz_id)
    ...
    #get_video_statistics(hob_ids).to_csv("VideoStatisiken/GrummelFritz")
